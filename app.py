...
def preparationData():
    ...
    # load main datasets
    apptrainPart1_1 , apptrainPart1_2, apptrainPart1_3, apptrainPart1_4=pd.read_csv("./application_trainPart1_1.csv"),pd.read_csv("./application_trainPart1_2.csv"),pd.read_csv("./application_trainPart1_3.csv"),pd.read_csv("./application_trainPart1_4.csv")
    apptrainPart2_1 , apptrainPart2_2, apptrainPart2_3, apptrainPart2_4=pd.read_csv("./application_trainPart2_1.csv"),pd.read_csv("./application_trainPart2_2.csv"),pd.read_csv("./application_trainPart2_3.csv"),pd.read_csv("./application_trainPart2_4.csv")
    ...
    aptestPart1, aptestPart2=pd.read_csv("./application_testPart1.csv"), pd.read_csv("./application_testPart2.csv")
...
def MainAppData(idUser):
    ...
    if currUser.empty == False:
        ...
        print("jvais bien a la fin de lgbm")
    else :
        finalResProba=[-1]
